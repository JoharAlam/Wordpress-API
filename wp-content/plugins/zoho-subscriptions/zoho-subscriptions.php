                ...
                <div class="zswelcomepanouter" id="api_key_div">
                    <div class="zswelcomepan">
                        ...
                        <div class="zswelheading" style="margin-top: 20px;text-align:center;">
                          Zoho Subscriptions Organization Details
                        </div>
                        ...
                        <div style="margin-top:40px;padding-left:40px;">
                            ...
                            <tr>
                                  <td height="150" width="75%">
                                    <div class="label">
                                      Select Domain<span style="font-size: 12px">  (The domain from which you access Zoho Subscriptions) </span>
                                    </div>
                                    <p>
                                      <label style="margin-right: 20px;">
                                        <input type="radio" name="zs_api_key[zs_domain]" class="domain" value="zoho.com" <?php if($domain === 'zoho.com') { ?> checked=true <?php } ?> /> 
                                        Zoho.com
                                      </label>
                                    </p>
                                    <p>
                                      <label>
                                        <input type="radio" name="zs_api_key[zs_domain]" class="domain" value="zoho.eu" <?php if($domain === 'zoho.eu') { ?> checked=true <?php } ?> />
                                        Zoho.eu
                                      </label>
                                    </p>
                                    <p>
                                      <label>
                                        <input type="radio" name="zs_api_key[zs_domain]" class="domain" value="zoho.in" <?php if($domain === 'zoho.in') { ?> checked=true <?php } ?> />
                                        Zoho.in
                                      </label>
                                    </p>
                                    <p>
                                      <label>
                                        <input type="radio" name="zs_api_key[zs_domain]" class="domain" value="zoho.com.au" <?php if($domain === 'zoho.com.au') { ?> checked=true <?php } ?> />
                                        Zoho.com.au
                                      </label>
                                    </p>
                                    <p>
                                      <label>
                                        <input type="radio" name="zs_api_key[zs_domain]" class="domain" value="zoho.com.cn" <?php if($domain === 'zoho.com.cn') { ?> checked=true <?php } ?> />
                                        Zoho.com.cn
                                      </label>
                                    </p>
                                  </td>
                                ...
                                <tr>
                                    ...
                                    <td height="45" width="70%">
                                      ...
                                      <div class="zslink" style="padding-top:5px;font-size:12px;font-style:italic;">
                                        You can find your domain and the Connector Key by going to Zoho Subscriptions -> Settings -> Integrations -> Other Apps -> WordPress Integration. 
                                        <a class="zssmallink" style="text-decoration:none;" href="https://www.zoho.com/subscriptions/help/wordpress-integration.html" id="help_link" target="_blank">
                                          Learn more.
                                        </a>
                                      </div>
...
function zs_embed_hosted_page($attr = array(), $content = null ) {
  ...
  if ( $domain === 'zoho.in' ) {
    $base_url = 'https://subscriptions.zoho.in/subscribe/';
  } else if ( $domain === 'zoho.eu' ) {
    $base_url = 'https://subscriptions.zoho.eu/subscribe/';
  } else if ( $domain === 'zoho.com.au') {
    $base_url = 'https://subscriptions.zoho.com.au/subscribe/';
  } else if ( $domain === 'zoho.com.cn') {
    $base_url = 'https://subscriptions.zoho.com.cn/subscribe/';
  } else {
    $base_url = 'https://subscriptions.zoho.com/subscribe/';
  }

  if($zs_api_key !='') {
    $org_digest =  $zs_api_key['zs_org_digest'];
    $iframeSrc =  $base_url . $org_digest . '/' . $plan_code;
    $iframeCode = '<iframe src="' .$iframeSrc . '" width=' . $width . ' height="900" id="ZSubscriptions" style="border:none;"></iframe>';
    return $iframeCode . $scriptUrl;
  }
  return 'Zoho Subscriptions plugin is not properly configured. Please uninstall and configure the plugin again.';
}
