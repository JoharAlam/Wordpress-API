...
[Zoho Subscriptions](https://www.zoho.com/subscriptions/) is billing software that makes it easy to handle your customers' entire billing life-cycle. It can help you with automated recurring billing, managing subscriptions, sending professional tax-compliant invoices, and getting paid on time, every time.

You must to have an account with Zoho Subscriptions to use this plugin, [sign up now](https://www.zoho.com/subscriptions/signup/), if you haven't already.
...
Learn more about the Zoho Subscriptions plugin from our [help document](https://www.zoho.com/subscriptions/help/wordpress-integration.html).

= WHO DO I CONTACT FOR MORE INFORMATION? =

You can reach out to our support team at support@zohosubscriptions.com with any questions you have about this plugin and we'd be happy to assist you.

== Screenshots ==

1. Zoho Subscriptions plugin - search result
2. Zoho Subscriptions plugin displayed in the WordPress plugins list
3. Zoho Subscriptions plugin account details page
4. Zoho Subscriptions account details page with connected organization
5. Zoho Subscriptions shortcode added in the page editor with the plan_code as "Basic" and width as "500"
6. Zoho Subscriptions checkout page in the WordPress site
